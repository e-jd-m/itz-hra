...
function setup() {
    ...
    player = new Player(maze.cells[floor(random(0, maze.cells.length - 1))].i + maze.cells[floor(random(0, maze.cells.length - 1))].a / 2, maze.cells[floor(random(0, maze.cells.length - 1))].j + maze.cells[floor(random(0, maze.cells.length - 1))].a / 2);
